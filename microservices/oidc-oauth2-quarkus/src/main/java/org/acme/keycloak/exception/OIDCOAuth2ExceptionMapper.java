...
import static org.acme.oidc.constants.MessagingConstants.INVALID_CLIENT_MSG;
import static org.acme.oidc.constants.MessagingConstants.PROCESSING_ERROR;
...
@Provider
@Slf4j
public class OIDCOAuth2ExceptionMapper implements ExceptionMapper<Throwable> {
